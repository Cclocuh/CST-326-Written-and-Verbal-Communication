...
namespace OnlineGroceryStore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var groceryStoreContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("OrderID,OrderDate,TotalPrice,CustomerID")] Order order)
        {
